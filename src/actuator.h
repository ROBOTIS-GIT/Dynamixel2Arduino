...
namespace ControlTableItem{
  enum ControlTableItemIndex{
    ...
    INVERTER_TEMPURATURE_LIMIT,
    MOTOR_TEMPURATURE_LIMIT,
    ...
    CONTROLLER_STATE,
    ERROR_CODE,
    ERROR_CODE_HISTORY_1,
    ERROR_CODE_HISTORY_2,
    ERROR_CODE_HISTORY_3,
    ERROR_CODE_HISTORY_4,
    ERROR_CODE_HISTORY_5,
    ERROR_CODE_HISTORY_6,
    ERROR_CODE_HISTORY_7,
    ERROR_CODE_HISTORY_8,
    ERROR_CODE_HISTORY_9,
    ERROR_CODE_HISTORY_10,
    ERROR_CODE_HISTORY_11,
    ERROR_CODE_HISTORY_12,
    ERROR_CODE_HISTORY_13,
    ERROR_CODE_HISTORY_14,
    ERROR_CODE_HISTORY_15,
    ERROR_CODE_HISTORY_16,
    HYBRID_SAVE,
    VELOCITY_FF_GAIN,
    POSITION_FF_GAIN,
    ...
    CURRENT_OFFSET,
    VELOCITY_OFFSET,
    PRESENT_INVERTER_TEMPERATURE,
    PRESENT_MOTOR_TEMPURATURE,
